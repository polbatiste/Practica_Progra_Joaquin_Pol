...
from routers.routers_productos import router as productos_router  # Importación del router de productos
...
# Incluir routers de dueños, citas, animales, tratamientos y productos
...
app.include_router(productos_router, prefix="/api/v1")  # Nueva línea para incluir el router de productos
